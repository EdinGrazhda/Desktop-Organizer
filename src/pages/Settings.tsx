      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6">
        ...
        <section>
          ...
          <div className="bg-white/3 rounded-xl border border-white/5 px-4">
            ...
            <ToggleRow
              ...
              description="Move files to Documents\\DeskNest\\Slots instead of only saving references"
        ...
        <section>
          ...
          <div className="bg-white/3 rounded-xl border border-white/5 p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-white">DeskNest</p>
              <p className="text-xs text-gray-500">
                Version 1.0.0 — Desktop slot organizer
              </p>
            </div>
          </div>
        </section>
